function setLightTheme() {
    ...
    $('body').css({ "background": "linear-gradient(to right, #191654, #43C6AC)" }); // Sets the background of the body element to a linear gradient
...
function setDarkTheme() {
    ...
    $('.navbar.navbar-expand-lg.navbar-light').css({ "background-color": "black" }); // Sets the background color of the navbar element to black
    $('#title1').css({ "color": "black" }); // Sets the text color of an element with id 'title1' to black
